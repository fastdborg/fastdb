...
3. Read the plan for the active phase. For Phase 5, [`plan-phase5.md`](plan-phase5.md) is the authoritative execution plan and Definition of Done. [`docs/phase0-report.md`](docs/phase0-report.md), [`docs/phase1-report.md`](docs/phase1-report.md), [`docs/phase2-report.md`](docs/phase2-report.md), [`docs/phase3-report.md`](docs/phase3-report.md), and [`docs/phase4-report.md`](docs/phase4-report.md) preserve completed evidence.
...
- Current implementation stage: Core Phase 5 release hardening described in `plan-phase5.md`; public release remains blocked on remote CI and legal review.
...
Phase 2 established stable format version 1, Phase 3 completed the synchronous frontend contract, and Phase 4 delivered the worker-backed asynchronous Rust API, transaction guard, and CLI. Phase 5 hardens that MVP for release review; the cloud service remains a later track.
...
Phase completion requires every checkbox in that phase's Definition of Done, not merely working happy-path code. For Phase 5, use the final report structure in `plan-phase5.md` and lead with `Stop for release review` plus the local and external-gate evidence.
