...
| One-hop forward links | tests/tests/links.rs; documented snapshot and batching probes | Initial per-resolver encoded-value bounds exist; total query/outer-result memory accounting and target-plan instrumentation remain open |
