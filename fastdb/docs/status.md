...
These helpers currently apply to object-write expressions; SQL SELECT/SET propagation remains incomplete. CASE/BETWEEN/LIKE and other broader expression grammar, doc::row, additional helper functions, general RETURNING, and full resource/concurrency verification remain open. No arbitrary JavaScript execution is introduced.
