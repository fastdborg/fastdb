...
CTEs, grouping aliases, DISTINCT/windows, compound sources, relational stars and other unsupported source shapes remain pending with broader SELECT work. Modified/compound VALUES sources fail explicitly instead of silently processing only their first VALUES component. This materializing implementation still needs bounded-memory/resource accounting and release-level concurrency verification.
