...
3. Complete forward-link resource/planner coverage; add bundled bounded QuickJS functions and verified exact upstream vectors. Vector bytes currently have no validated public constructor/field validator; do not advertise vector support yet.
