...
4. Native Node/TypeScript client and complete Rust packaging; lossless cross-language wire encoding; CLI interactive/streaming UX, import/export, migrations, schema/query-plan inspection.
