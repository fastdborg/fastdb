...
| N3 | Resolve application blockers | Reproduced SDK usage blockers from N2 are fixed with focused regressions; nonblocking limitations are documented | After N2 |
