...
The [UPDATE conflict guide](docs/update-conflicts.md) compares ABORT, ROLLBACK, FAIL, IGNORE and REPLACE, including retained changes on errors and transaction recovery.
